...
const RidesTab = () => {
  ...
  const approveRide = async (rideId) => {
    try {
      ...
      toast.success('Vožnja je uspešno odobrena!');
    } catch (error) {
      console.error('❌ [RidesTab] Error approving ride:', error);
      toast.error('Greška pri odobravanju vožnje: ' + error.message);
    }
  };
  ...
  const rejectRide = async (rideId) => {
    try {
      ...
      toast.success('Vožnja je odbijena!');
    } catch (error) {
      console.error('❌ [RidesTab] Error rejecting ride:', error);
      toast.error('Greška pri odbijanju vožnje: ' + error.message);
    }
  };
  ...
  const saveRideEdit = async () => {
    ...
    try {
      ...
      toast.success('Vožnja je uspešno izmenjena!');
    } catch (error) {
      console.error('❌ [RidesTab] Error saving ride edit:', error);
      toast.error('Greška pri čuvanju izmena: ' + error.message);
    }
  };

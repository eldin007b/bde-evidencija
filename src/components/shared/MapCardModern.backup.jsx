...
const MapCardModern = ({ 
  ...
  return (
    <div className={`flex flex-col bg-white border border-gray-200 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 w-full h-full ${className || ''}`} style={style}>
      {/* Integrated Address Search Bar */}
      <div className="flex items-start gap-3 p-4 bg-gray-50 border-b border-gray-200 relative w-full box-border shadow-sm z-[2000]">
        {/* Search input sa ikonom */}
        <div className="relative flex-1 flex items-center gap-2 w-full box-border">
          <div className="relative flex-1">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 w-4 h-4 z-[2]">
              <path d="M15.5 14h-.79l-.28-.27A6.471 6.471 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
            </svg>
            <input
              ref={inputRef}
              type="text"
              className="w-full pl-10 pr-3 py-2 rounded-lg border border-gray-300 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm placeholder-gray-500"
              value={inputValue}
          ...
          <button
            className="px-3 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"

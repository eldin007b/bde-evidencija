...
import styles from './MapCardModern.module.css';
  ...
  return (
    <div className={`${styles.mapCardModern} ${className}`} style={style}>
      ...
      <div className={styles.addressBarIntegrated}>
        {/* Zoom i Locate kontrole sa PRAVIM SVG IKONAMA */}
        <div className={styles.mapControlsCompact}>
          {/* ZUM IN - SVG ikona */}
          <button className={styles.controlBtn} onClick={handleZoomIn} title="Povećaj zoom">
          ...
          {/* ZUM OUT - SVG ikona */}
          <button className={styles.controlBtn} onClick={handleZoomOut} title="Smanji zoom">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <button className={styles.controlBtn} onClick={handleLocateMe} title="Lociraj na adresu">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">

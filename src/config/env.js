...
const ENV = {
  ...
  GOOGLE_DRIVE_API_KEY: _env.VITE_GOOGLE_DRIVE_API_KEY || _procEnv.VITE_GOOGLE_DRIVE_API_KEY || '',
  GOOGLE_DRIVE_FOLDER_ID: _env.VITE_GOOGLE_DRIVE_FOLDER_ID || _procEnv.VITE_GOOGLE_DRIVE_FOLDER_ID || ''
};

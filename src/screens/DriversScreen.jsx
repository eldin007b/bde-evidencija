...
export default function DriversScreen() {
  ...
  // Tematske boje i gradienti kao u DeliveriesScreen
  const themes = {
  ...
  return (
    <div className={`min-h-screen ${getThemeBackground()} ${currentTheme === 'night' ? 'text-white' : 'text-gray-800'}`}>
      ...
      {/* Modern Header sa glassmorphism */}
      <motion.header 
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 md:py-8">
        ...
        >
          ...
          {/* Driver Navigation - identical layout as month navigation */}
          ...
          {/* Stats Cards Grid sa animacijama */}
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full min-w-full">
                <thead className={`${
                  currentTheme === 'night' ? 'bg-gray-700/50 text-gray-300' : 'bg-gray-50 text-gray-700'
                }`}>
                  <tr>
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  {processedDeliveries.map((d, idx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm whitespace-nowrap">{d.packages || '–'}</td>
                        <td className="px-4 py-3 text-sm whitespace-nowrap">{d.pickupPackages || '–'}</td>
                        <td
                          className="px-4 py-3 text-sm whitespace-nowrap"
                        ...
                        <td className="px-4 py-3 text-sm whitespace-nowrap">{d.stopsPerHour ? d.stopsPerHour.toFixed(1) : '–'}</td>
                      </motion.tr>
                    );
                  })}
                  ...
                  <motion.tr 
                    ...
                    className={`${
                      currentTheme === 'night' ? 'bg-gray-700/70 font-bold' : 'bg-gray-50 font-bold'
                    }`}
                  >
                    ...
                    <td className="px-4 py-3 text-sm whitespace-nowrap"><strong>{processedDeliveries.reduce((sum, d) => sum + (d.pickupPackages || 0), 0)}</strong></td>
                    <td
                      className="px-4 py-3 text-sm whitespace-nowrap"
                      style={(() => {
